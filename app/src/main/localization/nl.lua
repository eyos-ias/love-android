return {
    ...
    misc={
        achievement_descriptions={
            ...
            card_discarder="500장 이상 버리기",
            card_player="500장 이상 플레이",
        ...
        dictionary={
            ...
            ph_click_confirm="Klik opnieuw om te bevestigen",
            ph_deck_preview_effective="Total effectif grâce aux Jokers",
