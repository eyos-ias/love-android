return {
    ...
    misc={
        ...
        achievement_names={
            ...
            speedrunner="快速破關者",
            tiny_hands="小手牌",
            you_get_what_you_get="Что вышло",
        },
        blind_states={
            Current="目前",
            Defeated="已被擊敗",
        ...
        dictionary={
            ...
            ph_alert_debuff_confirm=" чтобы подтвердить",
            ...
            ph_click_confirm=" чтобы подтвердить",
            ph_deck_preview_effective="Totale effettivo grazie a Jolly",
        ...
        v_dictionary={
            ...
            completed="已完成#1#/#2#",
            deck_preview_wheel_plural=" вытянутых лицом вниз",
            deck_preview_wheel_singular=" вытянутой лицом вниз",
