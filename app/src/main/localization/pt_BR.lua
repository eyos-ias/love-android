return {
    ...
    misc={
        ...
        achievement_names={
            ...
            you_get_what_you_get="Dostajesz to",
        },
        blind_states={
            Current="Atual",
            Defeated="Derrotado",
        ...
        dictionary={
            ...
            ph_alert_debuff_confirm=" aby potwierdzić",
            ...
            ph_click_confirm=" aby potwierdzić",
            ph_deck_preview_effective="Total efektif karena Joker",
            ph_deck_preview_stones="Pedras",
            ph_defeat_the_boss="Derrote o Blind de Chefe",
            ph_defeat_this_blind_1="Pokonaj tę Przeszkadzajkę",
