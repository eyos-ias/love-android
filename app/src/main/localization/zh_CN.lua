return {
    ...
    misc={
        ...
        dictionary={
            ...
            ph_alert_debuff_confirm="Нажмите «Играть» снова",
            ...
            ph_click_confirm="Щелкните снова",
            ph_deck_preview_effective=" dan peningkatan kartu",
            ...
            ph_up_ante_2="加注所有盲注",
            ph_up_ante_3="刷新盲注",
            ph_vouchers_redeemed=" выкупленные в этой партии",
            ph_you_win="你赢了！",
        ...
        v_dictionary={
            ...
            completed="#1#/#2#已完成",
            deck_preview_wheel_plural="Числа могут быть меньшими из-за #1# карт",
            deck_preview_wheel_singular="Числа могут быть меньшими из-за #1# карты",
